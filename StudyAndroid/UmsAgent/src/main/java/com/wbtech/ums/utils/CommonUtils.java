...
public class CommonUtils {
    ...
    public static String getOsVersion(Context context) {
        ...
        if (checkPhoneState(context)) {
            ...
            printLog("android_osVersion", "OsVerson" + osVersion, Log.DEBUG);
            return osVersion;
        } else {
            printLog("android_osVersion", "OsVerson get failed" + osVersion, Log.ERROR);
            return null;
        }
    }
    ...
    public static String getDeviceID(Context context) {
        ...
        if (checkPermissions(context, "android.permission.READ_PHONE_STATE")) {
            ...
            if (deviceId != null) {
                printLog("commonUtil", "deviceId:" + deviceId, Log.DEBUG);
                return deviceId;
            } else {
                printLog("commonUtil", "deviceId is null" + deviceId, Log.ERROR);
                return "";
            }
        } else {
            printLog("lost permissioin", "lost----->android.permission.READ_PHONE_STATE", Log.ERROR);
            return "";
        }
    }
    ...
    public static String getSdkVersion(Context paramContext) {
        ...
        if (!checkPhoneState(paramContext)) {
            osVersion = Build.VERSION.RELEASE;
            printLog("android_osVersion", "OsVerson" + osVersion, Log.ERROR);
            return osVersion;
        } else {
            printLog("android_osVersion", "OsVerson get failed", Log.ERROR);
            return null;
        }
    }
    ...
    public static String getCurVersion(Context context) {
        ...
        try {
            ...
            printLog("VersionInfo", e.toString(), Log.ERROR);
    ...
    public static SCell getCellInfo(Context context) throws Exception {
        ...
        if (location == null) {
            printLog("GsmCellLocation Error", "GsmCellLocation is null", Log.ERROR);
    ...
    public static boolean isNetworkTypeWifi(Context context) {
        ...
        if (checkPermissions(context, "android.permission.INTERNET")) {
            ...
            if (info != null && info.isAvailable() && info.getTypeName().equals("WIFI")) {
                ...
                printLog("error", "Network not wifi", Log.ERROR);
                return false;
            }
        } else {
            printLog(" lost  permission", "lost----> android.permission.INTERNET", Log.ERROR);
            return false;
        }
    ...
    public static String getVersion(Context context) {
        ...
        try {
            ...
            printLog("UmsAgent Exception ", e.toString(), Log.ERROR);
        }
        return versionName;
    }
    ...
    public static void printLog(String tag, String log, int level) {
        if (NetworkUitls.DebugMode == true) {
            if (level == Log.ERROR) {
                Log.e(tag, log);
